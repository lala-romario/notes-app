      ...
      <div class="mx-auto sm:px-6">
        <div class="flex h-16 items-center justify-between">
          ...
          <div>
            ...
            <a href="/signup" class="text-xl text-white hover:text-gray-400 duration-500 mr-10">Sign up</a>
            <a href="/login" class="text-xl text-white hover:text-gray-400 duration-500 mr-10">Log in</a>
          </div>
